...
import servletimg from "./servelt.webp";  {/* Corrected image name here */}
      ...
      <div className="body">
        <div className="timeline">
          ...
          <div className="container left-container">
            <img src={jsimg} alt="" />
            <div className="text-box">
              <p className="topic heading">JavaScript</p> {/* Corrected spelling here */}
              <p className="skill-desc">
          ...
          <div className="container right-container">
            ...
            <div className="text-box">
              <p className="topic heading">React JS</p> {/* Corrected "React Js" to "React JS" */}
              <p className="skill-desc">
          ...
          <div className="container left-container">
            <img src={servletimg} alt="" />
            <div className="text-box">
              <p className="topic heading">Servlet</p> {/* Corrected spelling here */}
              <p className="skill-desc">
